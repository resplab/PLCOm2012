...
plcom2012 <-
  function(age,
    ...
    if (race == 'White' |
      ...
      model <-
        0.0778868 * (age - 62) - 0.0812744 * (education - 4) - 0.0274194 * (bmi -
                                                                              27) + 0.3553063 *
        copd + 0.4589971 * cancer_hist + 0.587185 * family_hist_lung_cancer + 0.2597431 *
        smoking_status - 1.822606 * ((smoking_intensity / 10) ^ (-1) - 0.4021541613) + 0.0317321 * (duration_smoking -
                                                                                                      27) -
        0.0308572 * (smoking_quit_time - 10) - 4.532506
    }
    ...
    if (race == 'Black') {
      model <-
        ...
        smoking_status - 1.822606 * ((smoking_intensity / 10) ^ (-1) - 0.4021541613) + 0.0317321 * (duration_smoking -
                                                                                                      27) -
        0.0308572 * (smoking_quit_time - 10) - 4.532506 + 0.3944778
    }
    ...
    if (race == 'Hispanic') {
      model <-
        ...
        smoking_status - 1.822606 * ((smoking_intensity / 10) ^ (-1) - 0.4021541613) + 0.0317321 * (duration_smoking -
                                                                                                      27) -
        0.0308572 * (smoking_quit_time - 10) - 4.532506 - 0.7434744
    }
    ...
    if (race == 'Asian') {
      model <-
        ...
        smoking_status - 1.822606 * ((smoking_intensity / 10) ^ (-1) - 0.4021541613) + 0.0317321 * (duration_smoking -
                                                                                                      27) -
        0.0308572 * (smoking_quit_time - 10) - 4.532506 - 0.466585
    }
    ...
    if (race == 'Native Hawaiian' | race == 'Pacific Islander') {
      model <-
        ...
        smoking_status - 1.822606 * ((smoking_intensity / 10) ^ (-1) - 0.4021541613) + 0.0317321 * (duration_smoking -
                                                                                                      27) -
        0.0308572 * (smoking_quit_time - 10) - 4.532506 + 1.027152
    }
...
plcom2012(age=57, race="Black", education=6, bmi=24, copd=1, cancer_hist=1, family_hist_lung_cancer=1, smoking_status=1,
          smoking_intensity=3, duration_smoking=2, smoking_quit_time=3)
